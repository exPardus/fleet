...
- **Prefer respawn over marathon sessions.** A worker past roughly 30-40 turns, or acting confused, gets `fleet respawn`, not more steering. The journal makes the reset lossless.
