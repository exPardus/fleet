...
> |---|---|---|
> | `status`, `peek`, `result`, `home`, `doctor`, `q`, `knowledge`, `sup-status`, `sup-context`, `sup-guard` | not mutating — all ten are `TERMINUS_VIEW_VERBS` | **refused, rc 1** |
