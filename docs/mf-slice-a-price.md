...
Anchors this repo has already measured (`knowledge/lessons.md#2026-07-30-interface-stress`,
wave-30 interface stress test): **a `bin/fleet.py` merge runs ~60–65k tokens; a docs-only
merge ~35k.** Those numbers were
