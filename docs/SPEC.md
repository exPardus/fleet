...
claude --bg -n "sup|<inc>|successor" --settings state/worker-settings.json
       [--model m] (--permission-mode p | <mode_flags(SUCCESSOR_DEFAULT_MODE)>)
