...
| **`fleet doctor`** | 23 health checks in one command — hook wiring, stale sessions, orphaned mailboxes, stale attaches, version pins, how long since the last `autoclean` sweep, supervisor claim, and more. |
